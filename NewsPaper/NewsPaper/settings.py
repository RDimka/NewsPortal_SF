...
EMAIL_HOST_USER = 'rdimir@yandex.ru'#os.getenv('EMAIL_HOST_USER')  # ваше имя пользователя, например, если ваша почта user@yandex.ru, то сюда надо писать user, иными словами, это всё то что идёт до собаки
EMAIL_HOST_PASSWORD = "qazWSXedc123!@#[]"#os.getenv('EMAIL_HOST_PASSWORD')  # пароль от почты
